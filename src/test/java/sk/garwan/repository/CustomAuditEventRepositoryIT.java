...
import sk.garwan.config.audit.AuditEventConverter;
import sk.garwan.domain.PersistentAuditEvent;
...
import static sk.garwan.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
